...
# 解压预训练数据集
# 加--force-local以忽略dataset_dir的冒号，不然报错
tar -xvf "${dataset_dir}/mobvoi_seq_monkey_general_open_corpus.jsonl.tar.bz2" -C "${dataset_dir}" --force-local
